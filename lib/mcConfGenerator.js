...
exports.serverProperties = undefined;
...
var MC_PROPS_REGEX = /^MC_(.+)$/;

var globalConfToServerProperties = function globalConfToServerProperties(v, k) {
  return (0, _lodash.get)(k.match(MC_PROPS_REGEX), '[1]', false);
};
...
var serverProperties = exports.serverProperties = function serverProperties(conf) {
  return _ini2.default.stringify((0, _lodash.mapKeys)((0, _lodash.pickBy)(conf, globalConfToServerProperties), globalConfToServerProperties));
};