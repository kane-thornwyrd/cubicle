...
exports.cubicleConf = exports.eulaFile = exports.serverProperties = undefined;
...
exports.default = conf => Object.assign({}, defaultConf, conf);

const MC_PROPS_REGEX = /^MC_(.+)$/;
const EULA_PROPS_REGEX = /^EULA_(.+)$/;
const globalConfToServerProperties = (v, k) => (0, _lodash.get)(k.match(MC_PROPS_REGEX), '[1]', false);
const globalConfToEula = (v, k) => (0, _lodash.get)(k.match(EULA_PROPS_REGEX), '[1]', false);

const serverProperties = exports.serverProperties = conf => _ini2.default.stringify((0, _lodash.mapKeys)((0, _lodash.pickBy)(conf, globalConfToServerProperties), globalConfToServerProperties));

const eulaFile = exports.eulaFile = conf => _ini2.default.stringify((0, _lodash.mapKeys)((0, _lodash.pickBy)(conf, globalConfToEula), globalConfToEula));

const cubicleConf = exports.cubicleConf = conf => JSON.stringify(conf, undefined, 2);